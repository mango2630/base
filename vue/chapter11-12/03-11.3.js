...
function createRenderer(options) {
  ...
  function mountComponent(vnode, container, anchor = null) {
    ...
    const { render, data, beforeCreated, created, beforeMount, mounted, beforeUpdated, updated } = componentOptions;
...
const componentVNode = {
  // 为什么不直接使用 MyComponent.render()
  // 但这样就没办法区别组件，为什么要区分组件，是在真实渲染时有什么特殊之处？
  type: MyComponent,
}
